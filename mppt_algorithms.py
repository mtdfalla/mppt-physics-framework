...
-----------------------------------------
P&O   : ΔV = 1 V, minimum perturb period 0.05 s. With the 0.1 s
        simulation step, one decision executes per electrical update (100 ms).
INC   : ΔV = 1 V, same decision cadence as P&O (one per 100 ms update).
...
class PandO:
    ...
    T_perturb    : Minimum perturbation period [s] (0.05). One decision
                   executes per simulation step (0.1 s in the test matrix).
